...
if (((magrec2  > 2) && (bonrec2 > 2)) || ((cpusp3 > 1) && (wnctrec > 1)) || ((wnctrec7 > 2) && (cpusp3 > 1)))
printf("\n");
else
if (((bonrec2  > 2) && (magrec2 > 2)) || ((cpusp3 > 1) && (wnctrec > 1)) || ((wnctrec7 > 2) && (bonrec > 2)))
printf("\n");
else
if (((cpusp3  > 1) && (magrec2 > 2)) || ((bonrec > 2) && (wnctrec > 1)) || ((wnctrec7 > 2) && (bonrec2 > 2)))
printf("\n");
else
if (((wnctrec  > 1) && (magrec2 > 2)) || ((bonrec2 > 2) && (cpusp3 > 1)) || ((wnctrec7 > 2) && (wnctrec > 1)))
printf("\n");
else
if (((wnctrec7  > 2) && (magrec2 > 2)) || ((bonrec > 2) && (cpusp3 > 1)) || ((magrec2 > 2) && (bonrec > 2)))
printf("\n");
if (ctr2 > 0)
{
printf("\n     Total Won/Lost: %d/%d\n\n", wnct, cpuwn);
...
if ((cpuwn2 >= 1) && (torwnrt < wnrt) && (wnrtrec > wnrtrec3) && (wnrtrec == wnrt) && (torwnrt == wnrtrec3))///new// && (prntcor == 0))), took out torwnrt!
{
printf("  ");
}///new
}
...
if (diceQ == 2)
printf("     It was a fabulous match!\n");
if (diceQ == 3)
...
{
if (diceQ == 1)
printf("     That was a superb follow-up!\n");
if (diceQ == 2)
printf("     That was a powerful follow-up attack!\n");
if (diceQ == 3)
...
if ((new6 > 0) && (cpusp > 1) && (ctr < 6))
printf("     It was a fantastic finish!\n");
if (((new6 < 1) && (ctr > 5) && (cpusp > 1)) || ((new6 < 1) && (ctr > 5) && (cpusp < 2)) || ((new6 < 1) && (ctr < 6) && (cpusp > 1)) || ((new6 < 1)  && (cpusp < 2) && (ctr < 6)))
printf("\n");
if ((new6 > 0) && (cpusp > 1) && (ctr < 6))
...
{
printf("\n\n     You have to keep your guard up!");//TOOK 2 SPACES START OF LINE
}
...
if (diceQ == 2)
printf("     THAT WAS AN AMAZING CPU VICTORY!\n\n");
if (diceQ == 3)
printf("     AND AN OUTSTANDING CPU WIN!\n\n");
}
}
...
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
printf("     THAT'S A MEAN MANOEUVRE!\n\n");
if (diceQ == 2)
...
if (diceQ == 3)
printf("     This was an amazing tactical victory!\n");
}
if (ctr < 5)
...
if (diceQ == 6)
printf("     It was a good effort!\n\n");
diceQ1 = (rand() % 32) + 1;//14 16
if ((diceQ > 6) && (diceQ1 < 9))
printf("\n");
if (diceQ1 == 1)
...
if (diceQ1 == 3)
printf("     Don't give up the fight!\n\n");
if (diceQ1 == 4)
