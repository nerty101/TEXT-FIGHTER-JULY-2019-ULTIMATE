...
int maghyp = 0, maghyp1 = 0, maghyp2 = 0, wnct7 = 0, wnctrec7 = 0, fghton3 = 0, magcom2 = 0, cpulow = 0, boncncl = 0, magcncl = 0, hypsp3 = 0, wnctrecA = 0;
...
if (wnctrec > 1)
++wnctrecA;
if ((posdef > 0) && ((wnctrec7 > 2) || (wnctrec > 1)))
{
...
if (((posdef > 0) && (wnctrec7 < 3) && (wnctrecA > 0)) || ((posdef > 0) && (wnctrec7 < 3) && (wnctrecA < 1)) || ((posdef > 0) && (wnctrec < 2) && (wnctrecA < 1)) || ((posdef > 0) && (wnctrec < 2) && (wnctrecA > 0)))
printf("\n");
if ((posdef < 1) && ((magrec2  > 2) || (bonrec2 > 2) || (cpusp3 > 1)))
printf("\n");
if (ctr2 > 0)
{
...
printf("  ");
if  (((cpuwn2 == 1) && (torwnrt == wnrt) && (wnrtrec > wnrtrec3) && (wnrt == wnrtrec3)) || ((cpuwn2 == 1) && (torwnrt < wnrt) && (wnrtrec > wnrtrec3) && (wnrt > wnrtrec3)))
printf("  ");
...
if ((posdef < 1) && ((wnrtrec3 > 0) || (wnrtrec > 0) || ( torwnrt > 0) || (wnrt > 0)))
printf("\n");
...
if (((ctr < 7) &&  (cpusp > 1) && (new6 > 0)) || ((ctr > 6) &&  (cpusp > 1) && (new6 > 0)) || ((ctr < 7) &&  (cpusp < 2) && (new6 > 0)) || ((ctr < 7) && (cpusp < 2) && (new6 > 0)) || ((ctr > 6) && (cpusp < 2) && (new6 > 0)) || ((ctr > 6) && (cpusp > 1) && (new6 < 1)) || ((ctr < 7) && (cpusp > 1) && (new6 < 1)))
...
printf("     That was completely incredible!\n");
if  ((ctr < 7) && (cpusp < 2) && (new6 < 1))
...
printf("     That was completely awesome!\n");
